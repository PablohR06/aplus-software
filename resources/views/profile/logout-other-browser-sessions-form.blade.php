<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            ...
            dispositivos. Algunas de sus sesiones recientes se enumeran a continuación; sin embargo, esta lista puede no
            ser exhaustiva. Si crees que tu cuenta se ha visto comprometida, también debes actualizar tu contraseña.
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            <x-slot name="title">
                Cerrar sesión en otras sesiones de los navegadores
            </x-slot>

            <x-slot name="content">
                Introduzca su contraseña para confirmar que desea cerrar la sesión de las demás sesiones en todos sus dispositivos.
